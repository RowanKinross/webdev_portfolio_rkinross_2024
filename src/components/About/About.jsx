        ...
        <div className='row'>
          ...
          <div className='aboutText'>
            ...
            <div className=' aboutMeText'>
              ...
              <br/>
              <br/>
              In my personal pursuits, I apply a careful hands-on logic to everything I do - whether it's the precision engineering involved in renovating my home or the use of statistical data to streamline operations as a Head Chef. I have a holistic approach to well-being. I enjoy cycling, running and have a keen interest in nutrition. These diverse interests converge in my affinity for software development where I can build tools at the intersection of environmental sustainability and human well-being. I derive immense satisfaction from deciphering the mathematical patterns inherent in everyday life, and I translate this into the logic of the programs I build.
              <br/>
              <br/>
